        ...
        <div className={' flex'}>
            ...
            <div className={' hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-image bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative'}>
                ...
                <div className={' grid grid-cols-1 z-20'}>
                    <StatInfoCard icon={<LuTrendingUpDown />} label={'Track your Income & Expenses'} value={'430,000'} color={'bg-primary'}/>
                </div>

                <img src={LOGIN_IMAGE} className={' w-64 lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue-400/15'}/>
            </div>
        </div>
    );
}
